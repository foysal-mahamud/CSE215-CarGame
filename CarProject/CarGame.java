...
public class CarGame extends JFrame implements KeyListener, ActionListener {
    ...
    private int tree1ypos = 400, tree2ypos = -200, tree3ypos = -500,
                tree4ypos = 100, tree5ypos = -300, tree6ypos = 500;
    ...
    public void paint(Graphics g) {
        ...
        try {
            tree1 = new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("images/tree.png")));
        ...
        if (tree1ypos > 700) { num1 = random.nextInt(500); tree1ypos = -num1; }
        if (tree2ypos > 700) { num1 = random.nextInt(500); tree2ypos = -num1; }
        if (tree3ypos > 700) { num1 = random.nextInt(500); tree3ypos = -num1; }
        if (tree4ypos > 700) { num1 = random.nextInt(500); tree4ypos = -num1; }
        if (tree5ypos > 700) { num1 = random.nextInt(500); tree5ypos = -num1; }
        if (tree6ypos > 700) { num1 = random.nextInt(500); tree6ypos = -num1; }

        try {
            car = new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("images/car.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            car1 = new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("images/car1.png")));
            car2 = new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("images/car2.png")));
            car3 = new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("images/car3.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        // Collision detection
        if (y1pos > ypos && y1pos < ypos + 130 && carxpos[cxpos1] == xpos) { gameover = true; }
        if (y2pos > ypos && y2pos < ypos + 130 && carxpos[cxpos2] == xpos) { gameover = true; }
        if (y3pos > ypos && y3pos < ypos + 130 && carxpos[cxpos3] == xpos) { gameover = true; }
        if (ypos > y1pos && ypos < y1pos + 130 && carxpos[cxpos1] == xpos) { gameover = true; }
        if (ypos > y2pos && ypos < y2pos + 130 && carxpos[cxpos2] == xpos) { gameover = true; }
        if (ypos > y3pos && ypos < y3pos + 130 && carxpos[cxpos3] == xpos) { gameover = true; }
